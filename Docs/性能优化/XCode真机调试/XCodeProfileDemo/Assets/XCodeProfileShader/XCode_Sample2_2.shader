	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( v2f i  ) : SV_Target
			{
				...
				half4 value2 = SAMPLE_TEXTURE2D(_BaseMap2, sampler_BaseMap2, UV_0 * 1.01);
				half4 value3 = SAMPLE_TEXTURE2D(_BaseMap3, sampler_BaseMap3, UV_0 * 1.02);
				half4 value4 = SAMPLE_TEXTURE2D(_BaseMap4, sampler_BaseMap4, UV_0 * 1.03);
